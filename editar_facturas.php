<?php
	...
	$active_clientes="";
	$active_soporte="";		
	$title="Editar Factura | Soporte Sym";
  ...
  <body>
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<h4><i class='glyphicon glyphicon-edit'></i> Editar Presupuesto</h4>
		</div>
		<div class="panel-body">
		<?php 
			include("formularios/buscar_productos.php");
			include("formularios/registro_clientes.php");
	...
	<script type="text/javascript" src="assets/js/editar_factura.js"></script>
	<link rel="stylesheet" href="//code.jquery.com/ui/1.11.4/themes/smoothness/jquery-ui.css">
    <script src="//code.jquery.com/ui/1.11.4/jquery-ui.js"></script>
	<script>
		$(function() {
						$("#nombre_cliente").autocomplete({
							source: "./controlador/autocomplete/clientes.php",
							minLength: 2,
